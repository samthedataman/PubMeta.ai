...
import time
import logging
import StuffThatWorksScraperSymptoms, StuffThatWorksScraperComorbidities, StuffThatWorksScraperTreatments, StuffThatWorksScraperTriggers
...
if __name__ == "__main__":
    ...
    for i in range(num_processes):
        if i == 0:
            target_script = StuffThatWorksScraperSymptoms.main
        elif i == 1:
            target_script = StuffThatWorksScraperComorbidities.main
        elif i == 2:
            target_script = StuffThatWorksScraperTreatments.main
        elif i == 3:
            target_script = StuffThatWorksScraperTriggers.main
        processes.append(
