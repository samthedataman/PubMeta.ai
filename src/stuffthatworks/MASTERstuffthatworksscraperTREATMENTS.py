...
import time
import logging
import StuffThatWorksScraperTreatmentsSideEffects1, StuffThatWorksScraperTreatmentsSideEffects2, StuffThatWorksScraperTreatmentsSideEffects3, StuffThatWorksScraperTreatmentsSideEffects4, StuffThatWorksScraperTreatmentsSideEffects5
...
if __name__ == "__main__":
    ...
    for i in range(num_processes):
        if i == 0:
            target_script = StuffThatWorksScraperTreatmentsSideEffects1.main
        elif i == 1:
            target_script = StuffThatWorksScraperTreatmentsSideEffects2.main
        elif i == 2:
            target_script = StuffThatWorksScraperTreatmentsSideEffects3.main
        elif i == 3:
            target_script = StuffThatWorksScraperTreatmentsSideEffects4.main
        elif i == 4:
            target_script = StuffThatWorksScraperTreatmentsSideEffects5.main
        processes.append(
            multiprocessing.Process(target=run_script, args=(target_script,))
        )
    ...
    with open("script_logs_TREATMENTS.txt", "a") as file:
